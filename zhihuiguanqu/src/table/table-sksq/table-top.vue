    ...
    export default {
        ...
        methods:{
            ...
            Reload(){
                ...
                this.axios.get('/guanqu/table/ST_G_ZORD?_page_size='+this.list_input.pagesize+'&_page='+this.list_input.current+this.searchs,{params:{TM:this.form.date,ADDVCD:this.form.xzqh,Canal_Code:this.form.qd,CTYPE:this.form.zdlx,_orderby:this.form.field}}).then((res)=>{
                    console.log(res);
                    this.loading = false;
                    if(res.data.total == 0){
                ...
                this.axios.get('/guanqu/table/ST_G_ZORD').then((res)=>{
