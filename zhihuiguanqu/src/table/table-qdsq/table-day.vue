	...
	export default {
        ...
        methods:{
            ...
            Reload(){
                ...
                this.axios.get('/guanqu/table/ST_DCanal_C?_page_size=99999'+this.searchs,{params:{TM:this.form.date,ADDVCD:this.form.xzqh,Canal_Code:this.form.qd,STYPE:this.form.zdlx}}).then((res)=>{
                    console.log(res);
                    this.loading = false;
                    ...
                    for (var i = 0;i<this.Tables.data.length ; i++) {
                        ...
                        if (this.Tables.data[i].STYPE == '1') {
                          this.Tables.data[i].STYPE = '明渠';
                        }
                        if (this.Tables.data[i].STYPE == '2') {
                          this.Tables.data[i].STYPE = '堰槽';
                        }
                        if (this.Tables.data[i].STYPE == '3') {
                          this.Tables.data[i].STYPE = '渡槽';
                        }
                        if (this.Tables.data[i].STYPE == '4') {
                          this.Tables.data[i].STYPE = '管道';
                        }
                    }
                });
                //行政区划
