    ...
    <div>
        <Content :style="{padding: '24px', background: '#fff'}">
                    ...
                    <Row style="font-size: 16px;">
                        ...
                        <Col style='font-size: 14px;text-align: center;'>共{{Tables.total}}个站点、、 涨水站数（个）：XX、 降水站数（个）：XX <br>
                      最大涨幅站点：A、      涨幅（m）：XX.XX、     最大跌幅站点：B、      跌幅（m）：XX.XX <br>
                        平均水位：m，平均流量：m³/s，日流量：10⁶m³，警戒水位：m，日最高水位：m，日最低水位：m
                      </Col>
                    </Row>
                    <el-table
                        :data="data"
              ...
              <el-dialog title="综合报表" :visible.sync="dialog_detail_showing" width="1200px" append-to-body>
                    <Row>
                      <Col style="text-align: center;font-size: 20px;">
                        {{this.form.date}} 河道水情日表
                      </Col>
                    </Row>
                    <Row>
                      <Col style='text-align: center;'>
                      站点总数(个):{{Tables.total}}、 涨水站数（个）：XX、 降水站数（个）：XX <br>
                      最大涨幅站点：A、      涨幅（m）：XX.XX、     最大跌幅站点：B、      跌幅（m）：XX.XX <br>
                      </Col>
    ...
    export default {
        ...
        methods:{
            ...
            Reload(){
                ...
                this.axios.get('/guanqu/table/ST_RIVER_D?_page_size='+this.list_input.pagesize+'&_page='+this.list_input.current+this.searchs,{params:{TM:this.form.date,ADDVCD:this.form.xzqh,Canal_Code:this.form.qd,CTYPE:this.form.zdlx,_orderby:this.form.field}}).then((res)=>{
                    console.log(res);
                    this.loading = false;
                    if(res.data.total == 0){
