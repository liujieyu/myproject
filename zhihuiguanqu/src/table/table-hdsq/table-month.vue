    ...
    <div>
        <Content :style="{padding: '24px', background: '#fff'}">
                    ...
                    <Row style="font-size: 16px;">
                        ...
                        平均水位：m，平均流量：m³/s，月流量：10⁶m³，警戒水位：m，月最高水位：m，月最低水位：m</Col>
                    </Row>
                    <el-table
                        :data="data"
                        border
    ...
    export default {
        ...
        methods:{
            ...
            Reload(){
                ...
                this.axios.get('/guanqu/table/ST_RIVER_M?_page_size='+this.list_input.pagesize+'&_page='+this.list_input.current+this.searchs,{params:{YE:this.form.YE,MON:this.form.MON,ADDVCD:this.form.xzqh,Canal_Code:this.form.qd,CTYPE:this.form.zdlx,_orderby:this.form.field}}).then((res)=>{
                    console.log(res);
                    this.loading = false;
                    if(res.data.total == 0){
