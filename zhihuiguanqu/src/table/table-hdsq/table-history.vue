  ...
  <div>
    <Content :style="{padding: '24px', background: '#fff'}">
      ...
      <Row>
            ...
            <Col style='font-size: 14px;text-align: center;'>监测站名：{{CZMC}}、警戒水位（m）：XXX.XX <br>
          水位：m，流量：m³/s</Col>
        </Row>
      <Row :gutter="24" style="">
        <Col span="12">
...
export default {
  ...
  methods: {
    ...
    Reload() {
      this.loading = true;
      this.axios.get("/guanqu/table/ST_RIVER_R?_page_size=" +this.list_input.pagesize +"&_page=" +this.list_input.current+this.searchs,{params:{TM:'bt,'+this.form.date[0]+','+this.form.date[1],_orderby:this.form.field}}).then(res => {
          console.log(res);
        ...
        this.axios.get("/guanqu/table/ST_RIVER_R?_page=1&_page_size=99999"+this.searchs,{params:{TM:'bt,'+this.form.date[0]+','+this.form.date[1],_orderby:this.form.field}}).then(res => {
