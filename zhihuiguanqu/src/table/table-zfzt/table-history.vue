<template>
  <div>
    <Content :style="{padding: '24px', background: '#fff'}">
      ...
      闸阀门开度：m，过闸阀流量：m³/s，闸阀上水位：m，闸阀下水位：m</Col>
      </Row>
      <Row :gutter="16" style="">
        <Col>
        ...
        series: [
          {
            ...
            type: "line",
            yAxisIndex: 0,
            data:this.data.y4.list.reverse()
          ...
          },
          {
            ...
            type: "line",
            yAxisIndex: 0,
            data:this.data.y1.list.reverse()
          ...
          },
          {
            ...
            type: "line",
            yAxisIndex: 1,
            data:this.data.y2.list.reverse()
          ...
          },
          {
            ...
            type: "line",
            yAxisIndex: 1,
            data:this.data.y3.list.reverse()
