    ...
    <div>
        <Content :style="{padding: '24px', background: '#fff'}">
                    ...
                    <Row style="font-size: 16px;">
                      ...
                      闸阀上水位：m，闸阀下水位：m，平均流量：m³/s，日累计水量：m³</Col>
                    </Row>
                    <el-table
                        :data="data"
                        border
              ...
              <el-dialog title="综合报表" :visible.sync="dialog_detail_showing" width="1200px" append-to-body>
                    ...
                    <Row>
                      ...
                      <Col>闸阀上水位：m，闸阀下水位：m，平均流量：m³/s，日累计水量：m³</Col>
    ...
    export default {
        ...
        methods:{
            ...
            Reload(){
                ...
                this.axios.get('/guanqu/table/ST_DWAS_C?_page_size='+this.list_input.pagesize+'&_page='+this.list_input.current+this.searchs,{params:{TM:this.form.date,ADDVCD:this.form.xzqh,Canal_Code:this.form.qd,CTYPE:this.form.zdlx,_orderby:this.form.field}}).then((res)=>{
                    console.log(res);
                    this.loading = false;
                    if(res.data.total == 0){
                      this.axios.get('/guanqu/table/ST_WAS_R1?_page=1&_page_size=99999').then((res)=>{
                ...
                this.axios.get('/guanqu/table/ST_WAS_R1').then((res)=>{
