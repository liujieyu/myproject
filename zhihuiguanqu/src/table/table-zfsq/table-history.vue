...
export default {
  ...
  methods: {
    ...
    Reload() {
      this.loading = true;
      this.axios.get("/guanqu/table/ST_WAS_R?_page_size=" +this.list_input.pagesize +"&_page=" +this.list_input.current+this.searchs,{params:{TM:'bt,'+this.form.date[0]+','+this.form.date[1],_orderby:this.form.field}}).then(res => {
          console.log(res);
        ...
        this.axios.get("/guanqu/table/ST_WAS_R?_page=1&_page_size=99999"+this.searchs,{params:{TM:'bt,'+this.form.date[0]+','+this.form.date[1],_orderby:this.form.field}}).then(res => {
