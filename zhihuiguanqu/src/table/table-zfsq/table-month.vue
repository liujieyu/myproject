        ...
        <Content :style="{padding: '24px', background: '#fff'}">
                ...
                <el-dialog title="综合报表" :visible.sync="dialog_detail_showing" width="1200px" append-to-body>
                    ...
                    <Row>
                      ...
                      <Col>闸阀上水位：m，闸阀下水位：m，平均流量：m³/s，月累计水量：m³</Col>
    ...
    export default {
        ...
        methods:{
            ...
            Reload(){
                ...
                this.axios.get('/guanqu/table/ST_MWAS_C?_page_size='+this.list_input.pagesize+'&_page='+this.list_input.current+this.searchs,{params:{YE:this.form.YE,MON:this.form.MON,ADDVCD:this.form.xzqh,Canal_Code:this.form.qd,CTYPE:this.form.zdlx,_orderby:this.form.field}}).then((res)=>{
                    console.log(res);
                    this.loading = false;
                    if(res.data.total == 0){
