    ...
    <div>
        <Content :style="{padding: '24px', background: '#fff'}">
                    <Row type="flex" :gutter="16" justify="end">
                        ...
                        <Col>
                        <!-- 站名模糊搜索 -->
                            <Input search enter-button suffix="ios-search" placeholder="请输入用水单元名称" style="width: auto;margin-right: 10px;" @on-search="search" v-model="form.searchmsg" />
                        </Col>
                    </Row>
                    <Divider />
                    <el-table
...
<script type="text/javascript">
    ...
    export default {
        ...
        methods:{
            ...
            Reload(){
                this.loading = true;
                this.axios.get('/guanqu/admin/WRP_IrrBUUser?_page_size='+this.list_input.pagesize+'&_page='+this.list_input.current).then((res)=>{
                    console.log(res);
                    this.loading = false;
