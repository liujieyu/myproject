  ...
  <div>
    <Content :style="{padding: '24px', background: '#fff'}">
      ...
      <Row>
          ...
          正常电压范围：{{ZCDY.VOLMIN}}-{{ZCDY.VOLMAX}}V；单位:电压：V</Col>
        </Row>
      <Row :gutter="16" style="">
        <Col span="11">
          <el-table
...
export default {
  ...
  methods: {
    ...
    Reload() {
      this.loading = true;
      this.axios.get("/guanqu/table/ST_StationStatus_H?_page_size=" +this.list_input.pagesize +"&_page=" +this.list_input.current+this.searchs,{params:{TM:'bt,'+this.form.date[0]+','+this.form.date[1],_orderby:this.form.field}}).then(res => {
          console.log(res);
      ...
      this.axios.get("/guanqu/table/ST_StationStatus_H?_page=1&_page_size=99999"+this.searchs,{params:{TM:'bt,'+this.form.date[0]+','+this.form.date[1]}}).then(res => {
          ...
          this.data2 = this.transform_YXGK_data_into_ehart_data(this.data2,'zhuangtaishuju');
            console.log(this.transform_YXGK_data_into_ehart_data(res.data.rows,'zhuangtaishuju'));
          this.drawchart();
          this.data2 = {};
      });
