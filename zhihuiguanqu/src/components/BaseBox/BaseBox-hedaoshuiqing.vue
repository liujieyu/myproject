...
export default {
  ...
  methods: {
      ...
      var div = `<div>
        <div class="tip_row">
              ...
              <div class="tip_row">
                ...
                <span class="tip_col_5" >预警水位：</span>
                <span class="tip_col_7" id="${item.STCD}_YJZ"></span>
                <span class="tip_col_5" >预警流量：</span>
                <span class="tip_col_7" id="${item.STCD}_YJQ"></span>
              </div>
              <div class="divider"></div>
        <div id="${
          item.STCD
    ...
    search() {
      ...
      this.search_FeatrueLayer(4, body, this.featrue, newFeatureLayerOBJ => {
        this.baseBox_init();
