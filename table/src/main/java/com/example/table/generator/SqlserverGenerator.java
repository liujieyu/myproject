...
public class SqlserverGenerator {
    ...
    private static String url = "jdbc:sqlserver://222.240.238.58:4000;databaseName=IA_GIMSDB";
    private static String username = "sa";
    private static String password = "sa5607846";
    ...
    public static void main(String[] args) {
        ...
        strategy.setInclude("WRP_FieldInfo");
